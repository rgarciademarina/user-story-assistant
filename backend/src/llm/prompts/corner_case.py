...
corner_case_prompt = PromptTemplate(
    ...
    4. **IMPORTANTE: Limita tu respuesta a un MÁXIMO de 5 casos esquina.** Si hay más de 5 casos potenciales, selecciona los 5 más críticos o relevantes.

    Responde únicamente con las siguientes secciones claramente delimitadas:

    **Casos Esquina Actualizados:**
    Aquí van los casos esquina actualizados (máximo 5).
